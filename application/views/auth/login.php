...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url() ?>assets/img/sipedes.png" />
    <link rel="icon" type="image/png" href="<?= base_url() ?>assets/img/sipedes.png" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>Login Sistem Informasi Pelayanan Desa</title>
...
<body class="off-canvas-sidebar">
    <!-- <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=" ../ ">Sistem Informasi Pelayanan Desa Wancimekar</a>
            </div>
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="green">
                            ...
                            <form method="post" action="">
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" data-background-color="blue">
                                        <h4 class="card-title">Login Pegawai & RT</h4>
                                    </div>
                                    ...
                                    <div class="footer text-center">
                                        <a class="btn btn-md btn-green  text-white" href="<?= base_url() ?>home"> Kembali ke Website Desa</a>
                                    </div>
                                </div>
