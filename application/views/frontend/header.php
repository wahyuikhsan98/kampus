...
<head>
	...
	<title>Sipedes Wancimekar</title>
	<link rel="icon" type="image/x-icon" href="<?= base_url() ?>assets/img/sipedes.png" />
...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" alt="Kelurahan"> Wancimekar</a>
