...
<head>
	...
	<title><?= $title ?></title>
	<link rel="icon" type="image/x-icon" href="<?= base_url() ?>assets/img/sipedes.pnd" />
...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top" alt="Kelurahan"> Wancimekar</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<li class="nav-item"><a class="nav-link <?php if ($title == 'Tracking') : ?><?= 'active'; ?><?php endif; ?>" href="<?= base_url('tracking') ?>">Tracking Surat</a></li>
