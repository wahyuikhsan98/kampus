...
<footer class="footer py-4">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4 text-lg-left" style="color:white">Copyright © Desa Wancimekar <?= date('Y') ?>
            </div>
...
<script>
    $('#jenis').change(function() {
        ...
        const spkk = ['KK Lama (Asli & FC)', 'KTP', 'Surat Pindah dari daerah asal', 'FC Buku Nikah']
        const spna = ['FC KK Calon Suami & Istri', 'FC KTP Calon Suami & Istri', 'Pas Foto 3x4 Calon Suami & Istri', 'FC Akta Cerai (Bagi Janda/Duda)']
        const skkl = ['KK (Asli & FC)', 'KTP', 'Surat Keterangan Kelahiran dari Bidan/RS (Jika ada/ Optional)', ]
        const skkm = ['KK (Asli & FC)', 'KTP', 'Surat Keterangan Kematian (Jika ada/Optional)', ]
        const skp = ['KK (Asli & FC)', 'Data alamat daerah tujuan']
        const skd = ['KK (Asli & FC)', 'Data alamat daerah asal']
        const skbm = ['KK (Asli & FC)', 'KTP (Asli & FC)']
        const skph = ['KK (Asli & FC)', 'KTP (Asli & FC)', 'Surat Pernyataan dari yang bersangkutan(Optional)']
        const sktm = ['KK (Asli & FC)', 'KTP (Asli & FC)']
        const sku = ['KK (Asli & FC)', 'KTP (Asli & FC)', 'Izin Usaha']
        const skt = ['KTP (Asli & FC)', 'Surat Dasar Kepemilikan']
        const skgg = ['KTP (Asli & FC)', 'KTP (Asli & FC)']
        const situ = ['KTP (Asli & FC)', 'KTP (Asli & FC)']
        const simb = ['KTP (Asli & FC)', 'FC Surat Tanah Lokasi Bangunan']
