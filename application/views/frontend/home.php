 ...
 <header class="masthead">
 	<div class="container">
 		...
 		<div class="masthead-heading text-uppercase">Desa Wancimekar</div>
 ...
 <section class="page-section" id="profil">
 	<div class="container">
 		<div class="text-center">
 			...
 			<h3 class="section-subheading text-muted">Desa Wancimekar, Kecamatan kotabaru, Kabupaten Karawang</h3>
 		</div>
 		...
 		<div class="row">
 			<div class="col-lg-4 col-sm-6 mb-4">
 				<div class="portfolio-item">
 					...
 					<div class="portfolio-caption">
 						<div class="portfolio-caption-heading">Sruktur Desa Wancimekar</div>
 			...
 			<div class="col-lg-4 col-sm-6 mb-4">
 				<div class="portfolio-item">
 					...
 					<div class="portfolio-caption">
 						<div class="portfolio-caption-heading">Sruktur Pemuda Desa</div>
 						<div class="portfolio-caption-subheading text-muted">Klik + lihat detail</div>
 					</div>
 				</div>
 			</div>
 			...
 			<div class="container">
 				...
 				<div class="row text-justify pl-5 pr-5">
 					<p>Diberitahukan untuk melakukan Pengajuan Surat Online dimohon untuk melengkapi data dengan benar dan
 						...
 						form Pengajuan Surat Online dimohon kepada pengaju untuk datang langsung ke Kantor Desa Wancimekar,
